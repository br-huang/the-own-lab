...
function Slider({
  ...
  return (
    <SliderPrimitive.Root
      ...
      max={max}
      className={cn(
        'relative flex w-full touch-none items-center py-1 select-none data-[orientation=vertical]:h-full data-[orientation=vertical]:w-auto data-[orientation=vertical]:flex-col',
        className,
      )}
      {...props}
    >
